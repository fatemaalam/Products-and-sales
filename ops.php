...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="ops.php">All Product</a></li>
...
<?php
$result = $mysqli->query("SELECT prod_code, prod_name,  price FROM sales ");

if($result){ 

$products_item = '<table border="1" bordercolor="white" style="color:white;"><th>Product ID</th><th>Product Name</th><th>Price(taka)</th>
';
...
$products_item .= <<<EOT
    ...
    <td><p align="center">{$obj->prod_code}</p></td>
  
	<td><p align="center">{$obj->prod_name}</p></td>
