...
<?php
$result = $mysqli->query("SELECT id,username, email FROM users  ORDER BY id ASC");

if($result){ 
$products_item = '<table border="1" bordercolor="white" style="color:white;"><th>User ID</th><th>User name</th><th>Email</th>
...
$products_item .= <<<EOT
   ...
   <td><p align="center">{$obj->username}</p></td>
    <td><p align="center">{$obj->email}</p></td>
