...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="teen.php">TEEN</a></li>
	</ul>
</div>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM sale WHERE category='teen'  ORDER BY id ASC");
if($results){ 
...
$products_item .= <<<EOT
	...
	<img src="res/teen/{$obj->product_img_name}">
	<p align="left">{$obj->product_name}</p>
	<p align="left" style="font-size: 1.2em;">{$obj->price} </p>
